...
const SLIDES: OnboardingSlide[] = [
  {
    ...
    description: '¿No sabes qué comer hoy? Cero Ganas te ayuda a elegir rápido, sin vueltas ni complicaciones, ya sea para cocinar en casa o pedir por delivery.',
    image: './sidebar-sloth.jpg',
    highlights: [
      'Sin vueltas ni complicaciones',
      'Platos caseros y opciones de delivery en un solo lugar',
      'Tu chef perezoso decide por ti cuando no tenés ganas',
    ],
  },
  {
    badge: '20 platos y sorteo',
    badgeIcon: <Dices className="w-3.5 h-3.5 text-emerald-500" />,
    title: 'Navegá 20 opciones al azar',
    subtitle: 'Elegí tus favoritos y dejá que la suerte decida.',
    description: 'Recorré 20 tarjetas de comida con las flechas. Marcá «Me interesa» en las que te tienten (o volvé atrás si cambias de opinión).',
    image: './modal-bg-sloths.jpg',
    highlights: [
      'Al juntar la cantidad que elijas, empieza el Sorteo Final',
      'Tocá cualquier tarjeta para girarla y ver la receta o ingredientes',
      'Filtrá fácilmente por tipo de comida o categoría',
    ],
  },
  {
    badge: 'Modos especiales',
    badgeIcon: <Zap className="w-3.5 h-3.5 text-amber-500 fill-amber-500" />,
    title: '¡Tengo Hambre! y Despensa',
    subtitle: 'Decisión en 3 segundos o recetas con lo que tenés.',
    description: '¿Cero tiempo? Tocá «¡Tengo Hambre!» para decidir al instante. ¿Querés cocinar? Usá la «Despensa Inteligente».',
    image: './sloth-thinking.jpg',
    highlights: [
      '«¡Tengo Hambre!»: cuenta regresiva de 3 segundos y plato elegido por la suerte',
      '«Despensa»: marcá tus ingredientes y descubrí recetas listas para hacer',
      'Enlaces directos a PedidosYa, Rappi y Google',
    ],
  },
  {
    badge: '¡Todo listo!',
    ...
    subtitle: 'Accedé a esta guía cuando quieras desde la barra lateral.',
    description: 'Guardá tus platos en el historial, agregá tus favoritos y planificá tu semana. ¡Buen provecho!',
    image: './app-logo.jpg',
    highlights: [
      'Menú lateral con acceso a Historial, Favoritos y Plan Semanal',
      'Sección «Ayuda» siempre disponible para repasar cómo funciona',
      '100% adaptado a tu teléfono y computadora',
    ],
  },
];
